...
const genres = [
    { title: 'Literatura Brasileira', description: 'Obras da literatura brasileira' },
    { title: 'Ficção Científica', description: 'Histórias baseadas em ciência e tecnologia futurista' },
    { title: 'Realismo Mágico', description: 'Narrativas que mesclam realidade e elementos mágicos' },
    ...
    { title: 'Romance', description: 'Histórias focadas em relacionamentos e amor' },
    ...
    { title: 'Programação', description: 'Livros sobre desenvolvimento de software' },
    { title: 'Negócios', description: 'Temas relacionados a empreendedorismo e gestão' },
    { title: 'Psicologia', description: 'Estudos sobre comportamento e mente humana' },
    ...
    { title: 'Graphic Novel', description: 'Histórias em quadrinhos e romances gráficos' },
    ...
    { title: 'Educação', description: 'Temas relacionados ao ensino e aprendizagem' },
